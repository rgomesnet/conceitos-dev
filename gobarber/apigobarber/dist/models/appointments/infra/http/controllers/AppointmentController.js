...
var CreateAppointmentService_1 = __importDefault(require("@models/appointments/services/CreateAppointmentService"));
...
var AppointmentController = /** @class */ (function () {
    ...
    AppointmentController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, provider_id, date, user_id, service, parsedDate, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, provider_id = _a.provider_id, date = _a.date;
                        user_id = request.user.id;
                        service = tsyringe_1.container.resolve(CreateAppointmentService_1.default);
                        console.log('oi');
