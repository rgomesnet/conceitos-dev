...
var FakeAppointmentRepository = /** @class */ (function () {
    function FakeAppointmentRepository() {
        this.appointments = [];
    }
    FakeAppointmentRepository.prototype.findInDayFromProvider = function (_a) {
    ...
    FakeAppointmentRepository.prototype.findByDate = function (date) {
        return __awaiter(this, void 0, void 0, function () {
            var appointment;
            return __generator(this, function (_a) {
                appointment = this.appointments.find(function (a) { return a.date == a.date; });
                return [2 /*return*/, appointment];
            });
        });
    };
    FakeAppointmentRepository.prototype.findInMonthFromProvider = function (_a) {
        var provider_id = _a.provider_id, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var appointments;
            return __generator(this, function (_b) {
                appointments = this.appointments.filter(function (ap) {
                    return ap.provider_id === provider_id &&
                        (date_fns_1.getMonth(ap.date) + 1) === month &&
                        date_fns_1.getYear(ap.date) === year;
                });
                return [2 /*return*/, appointments];
            });
        });
    };
    FakeAppointmentRepository.prototype.create = function (_a) {
...
exports.default = FakeAppointmentRepository;
