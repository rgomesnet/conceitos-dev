...
var ListProviderMonthAvailabilityService = /** @class */ (function () {
    function ListProviderMonthAvailabilityService(appointmentRepository) {
    ...
    ListProviderMonthAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointments, numberOfDaysInMonth, eachDayInMont, availability;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointmentRepository.findInMonthFromProvider({
                    ...
                    case 1:
                        ...
                        eachDayInMont = Array.from({ length: numberOfDaysInMonth }, function (_, index) { return index + 1; });
                        availability = eachDayInMont.map(function (day) {
