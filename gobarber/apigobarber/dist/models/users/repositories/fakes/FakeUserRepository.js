...
var User_1 = __importDefault(require("@models/users/infra/typeorm/entities/User"));
var FakeUserRepository = /** @class */ (function () {
    function FakeUserRepository() {
        this.users = [];
    }
    FakeUserRepository.prototype.findAllProviders = function (_a) {
        var except_user_id = _a.except_user_id;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                if (except_user_id) {
                    return [2 /*return*/, this.users.filter(function (user) { return user.id !== except_user_id; })];
                }
                return [2 /*return*/, this.users];
            });
        });
    };
    FakeUserRepository.prototype.all = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    FakeUserRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var index;
            return __generator(this, function (_a) {
                index = this.users.findIndex(function (findUser) { return findUser.id == user.id; });
