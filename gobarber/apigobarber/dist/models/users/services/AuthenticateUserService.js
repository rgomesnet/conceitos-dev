...
var AuthenticateUserService = /** @class */ (function () {
    function AuthenticateUserService(repository, hashProvider) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('Incorret email/password combination 01', 401);
                        }
                        return [4 /*yield*/, this.hashProvider.compare(password, user.password)];
                    case 2:
                        passwordMatched = _c.sent();
                        if (!passwordMatched) {
                            throw new AppError_1.default('Incorret email/password combination 02', 401);
                        }
