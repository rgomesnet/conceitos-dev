...
describe('AuthenticateUserService', function () {
    beforeEach(function () {
        ...
        hasProvider = new FakeHashProvider_1.default();
        createUserService = new CreateUserService_1.default(fakeUserRepository, hasProvider);
        service = new AuthenticateUserService_1.default(fakeUserRepository, hasProvider);
    });
    ...
    it('Should not be able to authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
