...
var ResetPasswordService = /** @class */ (function () {
    function ResetPasswordService(repository, userTokenRepository, hashProvider) {
    ...
    ResetPasswordService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userToken, user, tokenCreateAt, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.repository.findById(userToken.user_id)];
                    case 2:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('User does not exists');
                        }
                        tokenCreateAt = userToken.created_at;
                        if (date_fns_1.differenceInHours(Date.now(), tokenCreateAt) > 2) {
    ...
    ResetPasswordService = __decorate([
        ...
        __param(1, tsyringe_1.inject('UserTokenRepository')),
