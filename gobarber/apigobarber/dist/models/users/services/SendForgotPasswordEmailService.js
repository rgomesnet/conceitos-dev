...
var SendForgotPasswordEmailService = /** @class */ (function () {
    function SendForgotPasswordEmailService(repository, mailProvider, userTokenRepository) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.mailProvider.send({
                                to: {
                                    name: user.name,
                                    email: user.email
                                },
    ...
    SendForgotPasswordEmailService = __decorate([
        ...
        __param(2, tsyringe_1.inject('UserTokenRepository')),
