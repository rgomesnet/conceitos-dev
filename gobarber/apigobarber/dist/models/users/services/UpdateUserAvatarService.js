...
var UpdateUserAvatarService = /** @class */ (function () {
    function UpdateUserAvatarService(repository, storage) {
    ...
    UpdateUserAvatarService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.repository.findById(user_id)];
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('Only authenticated users can change avatar');
                        }
                        if (!user.avatar) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.storage.delete(user.avatar)];
                    case 2:
                        _c.sent();
                        _c.label = 3;
                    case 3:
                        _b = user;
                        return [4 /*yield*/, this.storage.save(avatarFilename)];
                    case 4:
                        _b.avatar = _c.sent();
