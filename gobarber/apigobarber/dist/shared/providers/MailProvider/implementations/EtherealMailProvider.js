...
var EtherealMailProvider = /** @class */ (function () {
    ...
    EtherealMailProvider.prototype.send = function (_a) {
        var to = _a.to, from = _a.from, subject = _a.subject, template = _a.template;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.mailTemplateProvider.parse(template)];
